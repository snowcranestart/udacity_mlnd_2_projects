...
class LearningAgent(Agent):
    ...
    def reset(self, destination=None, testing=False):
        ...
        if self.learning:
            ...
            #self.epsilon = math.pow(a, self.t)
            #self.epsilon = self.epsilon*a
            #self.epsilon = self.epsilon - 0.05
            if self.epsilon > 0.85:
                self.alpha = 0.9
            elif self.epsilon > 0.65:
                self.alpha = 0.7
            elif self.epsilon > 0.5:
                self.alpha = 0.6
            elif self.epsilon > 0.35:
                self.alpha = 0.4
            elif self.epsilon > 0.15:
                self.alpha = 0.2
            else:
                self.alpha = 0.1
        ...
        if self.learning:
            if state not in self.Q.keys():
                ...
                for action in self.valid_actions:
                    state_dic[action] = 0.0
                self.Q[state]= state_dic
    ...
    def choose_action(self, state):
        ...
        if not self.learning:
            ...
            if random.random() < self.epsilon:
                ...
                max_actions = [action for action, value in self.Q[state].items() if value == maxQ]
